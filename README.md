...
This is a sample template for dojo-ippon - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name dojo-ippon --query 'Stacks[].Outputs'
```
